...
export default function Lanyard({
  ...
  return (
    <div className="relative z-0 w-full h-full overflow-visible flex justify-center items-center transform scale-[1.22] sm:scale-[1.12] lg:scale-100 origin-center">
      <Canvas
        camera={{ position, fov }}
...
function Band({ maxSpeed = 50, minSpeed = 0 }: BandProps) {
  ...
  const j1 = useRef<RapierRigidBody & { lerped?: THREE.Vector3 } | null>(null);
  const j2 = useRef<RapierRigidBody & { lerped?: THREE.Vector3 } | null>(null);
